...
class RemoteVideoPlayer extends StatefulWidget {
  const RemoteVideoPlayer({super.key});
      ...
      children: <Widget>[
        ...
        ClipRRect(
          ...
          child: VideoProgressIndicator(
            _controller,
            padding: const EdgeInsets.only(bottom: 75, right: 70, left: 70),
            allowScrubbing: true,
            colors: const VideoProgressColors(playedColor: Color(0xFF00CCFF)),
          ),
        ),
      ],
    );
